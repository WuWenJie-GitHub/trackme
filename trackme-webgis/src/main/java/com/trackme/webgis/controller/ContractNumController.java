 ...
 */
@RestController
@RequestMapping("webgis/contractnum")
public class ContractNumController {
    ...
    public R info(@PathVariable("id") Integer id){
        ...
        return R.ok().put("contractNum", null);
    }
     ...
     */
    @RequestMapping("/save")
    public R save(@RequestBody ContractNumEntity contractNum){
    ...
    public R update(@RequestBody ContractNumEntity contractNum){
