 ...
 */
@RestController
@RequestMapping("webgis/newalarm")
public class NewalarmController {
     ...
     */
    @RequestMapping("/save")
    public R save(@RequestBody NewalarmEntity newalarm){
    ...
    public R update(@RequestBody NewalarmEntity newalarm){
